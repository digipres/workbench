...
This is an experiment in visualising the technical architecture of digital preservation services by focussing on how data flows over time. See [the `dataflow` GitHub issues](https://github.com/digipres/workbench/issues?q=state:open+label:"dataflows") for known/outstanding issues.
